...
from adminapp.views import index, admin_users, admin_users_create, admin_users_update, admin_users_delete, \
    ...
    admin_products_create, admin_products_update, admin_products_delete, admin_users_restore, admin_categories_restore, \
...
urlpatterns = [
    ...
    path('users-restore/<int:pk>', admin_users_restore, name='admin_users_restore'),
